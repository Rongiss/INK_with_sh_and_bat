#!/bin/bash
# Этот скрипт выполняет Python код

echo "Запуск Python скрипта из shell-скрипта"

# Вызов Python для выполнения встроенного кода
python3 - <<EOF
...
print("Это Python-код, встроенный в shell-скрипт.")
EOF
